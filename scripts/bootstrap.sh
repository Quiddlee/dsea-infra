...
AI_CORE_URL="${AI_CORE_URL:-http://ai-core-api:3000}"
...
KNOWLEDGE_BASE_VECTOR_STORE_NAME="${KNOWLEDGE_BASE_VECTOR_STORE_NAME:-knowledge_base}"
LLAMA_CLOUD_API_KEY="${LLAMA_CLOUD_API_KEY:-}"
GOOGLE_CLOUD_API_KEY="${GOOGLE_CLOUD_API_KEY:-}"
GRADEBOOK_SPREADSHEET_ID="${GRADEBOOK_SPREADSHEET_ID:-}"
...
: "${GRADEBOOK_SPREADSHEET_ID:?Missing GRADEBOOK_SPREADSHEET_ID in .env}"
...
KNOWLEDGE_BASE_VECTOR_STORE_NAME=${KNOWLEDGE_BASE_VECTOR_STORE_NAME}
LLAMA_CLOUD_API_KEY=${LLAMA_CLOUD_API_KEY}
GOOGLE_CLOUD_API_KEY=${GOOGLE_CLOUD_API_KEY}
GRADEBOOK_SPREADSHEET_ID=${GRADEBOOK_SPREADSHEET_ID}
EOF
